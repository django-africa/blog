...
from .views import UserViewSet, EventViewset, PostViewSet, AdvertViewSet, ContactViewSet, CommentViewSet, PrayerRequestViewSet, CategoryViewSet, PublicationViewSet, MinistriesViewset
